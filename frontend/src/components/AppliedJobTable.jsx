...
//                 <TableCell>{appliedJob.createAt.split("T")[0]}</TableCell>
              ...
              allAppliedJobs.map(appliedJob => (
                <TableRow key={appliedJob._id}>
                  ...
                  {/* <TableCell className="text-right">
                    <Badge className={`${appliedJob.status==="rejected"? 'bg-red-500':appliedJob.status==='pending'?'bg-gray-400':'bg-green-400'}`}></Badge>
                  </TableCell> */}
                  <TableCell className="text-right">
